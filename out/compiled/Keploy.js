	...
	function create_else_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path0, file, 147, 107, 4337);
				...
				add_location(path1, file, 147, 207, 4437);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 147, 20, 4250);
			},
	...
	function create_if_block_1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(path, file, 145, 107, 4038);
				attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg, "width", "35px");
				attr_dev(svg, "height", "35px");
				attr_dev(svg, "viewBox", "0 0 24 24");
				add_location(svg, file, 145, 20, 3951);
			},
			m: function mount(target, anchor) {
				insert_dev(target, svg, anchor);
				append_dev(svg, path);
	...
	function create_if_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(button0, "class", "button svelte-gej4dp");
				button0.disabled = /*isRecording*/ ctx[4];
				add_location(button0, file, 159, 12, 6245);
				attr_dev(button1, "id", "startTestingButton");
				attr_dev(button1, "class", "button svelte-gej4dp");
				button1.disabled = /*isRecording*/ ctx[4];
				add_location(button1, file, 162, 12, 6444);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(159:8) {#if selectedIconButton === 1}",
			ctx
		});
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(input0, "class", "svelte-gej4dp");
				add_location(input0, file, 124, 12, 3127);
				attr_dev(div0, "id", "appCommandDiv");
				attr_dev(div0, "class", "svelte-gej4dp");
				add_location(div0, file, 123, 8, 3090);
				attr_dev(button0, "id", "selectRecordFolderButton");
				attr_dev(button0, "class", "button svelte-gej4dp");
				add_location(button0, file, 133, 12, 3399);
				attr_dev(input1, "type", "text");
				attr_dev(input1, "id", "recordProjectFolder");
				attr_dev(input1, "name", "projectFolder");
				attr_dev(input1, "class", "svelte-gej4dp");
				toggle_class(input1, "isVisible", /*isProjectFolderVisible*/ ctx[6]);
				add_location(input1, file, 134, 12, 3495);
				attr_dev(div1, "id", "selectFolderDiv");
				attr_dev(div1, "class", "svelte-gej4dp");
				add_location(div1, file, 132, 8, 3360);
				attr_dev(button1, "class", button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[5] === 1 ? 'selected' : '') + " svelte-gej4dp");
				add_location(button1, file, 143, 12, 3790);
				...
				add_location(path0, file, 151, 103, 4854);
				attr_dev(svg0, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg0, "width", "35px");
				attr_dev(svg0, "height", "35px");
				attr_dev(svg0, "viewBox", "0 0 24 24");
				add_location(svg0, file, 151, 16, 4767);
				attr_dev(button2, "class", button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[5] === 2 ? 'selected' : '') + " svelte-gej4dp");
				add_location(button2, file, 150, 12, 4644);
				...
				add_location(path1, file, 154, 103, 5428);
				attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
				attr_dev(svg1, "width", "35px");
				attr_dev(svg1, "height", "35px");
				attr_dev(svg1, "viewBox", "0 0 24 24");
				add_location(svg1, file, 154, 16, 5341);
				attr_dev(button3, "class", button3_class_value = "icon-button " + (/*selectedIconButton*/ ctx[5] === 3 ? 'selected' : '') + " svelte-gej4dp");
				add_location(button3, file, 153, 12, 5218);
				attr_dev(div2, "class", "icon-buttons svelte-gej4dp");
				add_location(div2, file, 142, 8, 3751);
				add_location(hr, file, 157, 8, 6188);
				attr_dev(div3, "class", "loader svelte-gej4dp");
				attr_dev(div3, "id", "loader");
				add_location(div3, file, 164, 8, 6590);
				attr_dev(button4, "id", "stopRecordingButton");
				attr_dev(button4, "class", "svelte-gej4dp");
				add_location(button4, file, 165, 8, 6637);
				attr_dev(h3, "id", "recordStatus");
				attr_dev(h3, "class", "svelte-gej4dp");
				add_location(h3, file, 166, 8, 6729);
				attr_dev(div4, "id", "recordedTestCases");
				attr_dev(div4, "class", "svelte-gej4dp");
				add_location(div4, file, 167, 8, 6766);
				attr_dev(div5, "class", "menu");
				add_location(div5, file, 122, 4, 3063);
				attr_dev(main, "class", "svelte-gej4dp");
				add_location(main, file, 121, 0, 3052);
			},
			...
			p: function update(ctx, [dirty]) {
				...
				if (dirty & /*selectedIconButton*/ 32 && button1_class_value !== (button1_class_value = "icon-button " + (/*selectedIconButton*/ ctx[5] === 1 ? 'selected' : '') + " svelte-gej4dp")) {
					attr_dev(button1, "class", button1_class_value);
				}

				if (dirty & /*selectedIconButton*/ 32 && button2_class_value !== (button2_class_value = "icon-button " + (/*selectedIconButton*/ ctx[5] === 2 ? 'selected' : '') + " svelte-gej4dp")) {
					attr_dev(button2, "class", button2_class_value);
				}

				if (dirty & /*selectedIconButton*/ 32 && button3_class_value !== (button3_class_value = "icon-button " + (/*selectedIconButton*/ ctx[5] === 3 ? 'selected' : '') + " svelte-gej4dp")) {
